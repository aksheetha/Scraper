...
query = "site:linkedin.com/in/ Technology Startup Advisor"
...
# Optional: Set up proxy (replace with your proxy details if needed)
...
time.sleep(random.uniform(3, 6))  # Random delay to ensure the page loads
...
tech_keywords = [
    ...
    "Cloud", "Cybersecurity", "Data", "AI", "Machine Learning", "Development",
...
try:
    ...
    max_pages = 30  # Set a limit for the number of pages to scrape
    ...
    while page_count < max_pages:
        ...
        try:
            ...
            if next_button.is_displayed():
                next_button.click()
                time.sleep(random.uniform(10, 20))  # Longer, random delay to mimic human behavior
            else:
